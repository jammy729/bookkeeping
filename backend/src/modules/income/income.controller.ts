...
import { IncomeService, CreateIncomeDto, UpdateIncomeDto } from './income.service';
...
export class IncomeController {
  ...
  getTotal(
    ...
    return this.incomeService.getTotalByPeriod(req.user.userId, startDate, endDate);
  }
  ...
  getByType(
    ...
    return this.incomeService.getTotalByType(req.user.userId, startDate, endDate);
  }
  ...
  getByClient(
    ...
    return this.incomeService.getTotalByClient(req.user.userId, startDate, endDate);
  }
}
