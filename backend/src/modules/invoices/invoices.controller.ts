...
export class InvoicesController {
  ...
  async markAsSent(@Param('id', ParseUUIDPipe) id: string, @Query('userId') userId: string) {
  ...
  async markAsPaid(@Param('id', ParseUUIDPipe) id: string, @Query('userId') userId: string) {
